...
-- Courses
INSERT INTO Course (Course_ID, Department_ID, Course_Number, Course_Name, Semester, Academic_Year) VALUES ('C101', 'CSC', 'CSC101', 'Intro to Programming', 'Fall', '2025');
INSERT INTO Course (Course_ID, Department_ID, Course_Number, Course_Name, Semester, Academic_Year) VALUES ('C102', 'CSC', 'CSC201', 'Databases', 'Spring', '2026');
INSERT INTO Course (Course_ID, Department_ID, Course_Number, Course_Name, Semester, Academic_Year) VALUES ('M101', 'MAT', 'MAT101', 'Discrete Mathematics', 'Fall', '2025');

-- CS101: 5 Students
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('11111111', 'C101');
...
-- CS201: 4 Students
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('66666666', 'C102');
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('77777777', 'C102');
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('88888888', 'C102');
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('99999999', 'C102');

-- MATH101: 4 Students
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('11111111', 'M101');
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('10101010', 'M101');
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('55555555', 'M101');
INSERT INTO Enrollment (Student_ID, Course_ID) VALUES ('88888888', 'M101');
...
INSERT INTO Grade_Category (Category_ID, Course_ID, Category_Name, Weight_Percentage) VALUES ('3', 'C102', 'Projects', 50);
INSERT INTO Grade_Category (Category_ID, Course_ID, Category_Name, Weight_Percentage) VALUES ('4', 'C102', 'Exams', 50);

-- MATH101: 20% Participation, 80% Exams
INSERT INTO Grade_Category (Category_ID, Course_ID, Category_Name, Weight_Percentage) VALUES ('5', 'M101', 'Participation', 20);
INSERT INTO Grade_Category (Category_ID, Course_ID, Category_Name, Weight_Percentage) VALUES ('6', 'M101', 'Exams', 80);
...
-- Helper Table Creation (Updated Types)
...
-- Execute the math into the helper table
